...
public class BookingPlugin
{
    ...
    public string BookSlot(
        ...
        [Description("The title of the booking slot, Example: 'Meeting with John', 'Lunch with Customer'")] string bookingReason,
        [Description("The datetime when the slot should start, in ISO 8601 format. Example: 2021-09-01T10:00:00+02:00")] string startDate,
        [Description("The length of the slot in minutes.")] int slotLength
    )
    {
        Console.WriteLine($"BookSlot function called with parameters: {employeeId}, {bookingReason}, {startDate}, {slotLength}");
